...
{
	mProgramId = Utility::atLoadShaders("../Common/Shaders/SimpleColor.vs", "../Common/Shaders/SimpleColor.fs");
}
...
void atRenderEngine::Utility::atLineShader::DrawRay(RayData & ray, Matrix4f & MVP)
{
	...
	Vector3f target = ray.rayOrigin + 100 * ray.rayDirection;
	...
	//GLuint programID = Utility::atLoadShaders("../Common/Shaders/SimpleColor.vs", "../Common/Shaders/SimpleColor.fs");
	//// Get a handle for our "MVP" uniform
