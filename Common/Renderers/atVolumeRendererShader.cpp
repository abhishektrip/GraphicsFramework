...
void atRenderEngine::Utility::atVolumeRenderingShader::Setup(atQuad& quad, const char * volume, unsigned int xRange, unsigned int yRange, unsigned int zRange)
{
...
void atRenderEngine::Utility::atVolumeRenderingShader::Draw(atQuad& quad, int numberOfSlices, Matrix4f & viewMatrix, Matrix4f & projectionMatrix)
{
